...
const Hero = () => {
  return (
    <section className="flex w-full justify-center bg-gray-100">
      ...
      <div className="section-padding-y w-full max-w-7xl md:flex md:space-x-8 section-padding-x">
        ...
        <div className="flex flex-1 flex-col">
          ...
          <div className="mt-5 flex max-[390px]:flex-col gap-3">
            <Input
        ...
        <div className="flex flex-1 max-md:mt-6 items-center justify-center">
          <div className="w-full max-w-[500px] md:max-w-[450px]">
            <HeroSvg className=""/>
          </div>
        </div>
      </div>
